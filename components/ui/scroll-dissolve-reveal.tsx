...
/** Texture images arrive as HTMLImageElement / ImageBitmap; both carry size. */
...
/**
 * The WebGL layer alone, driven by an external scroll progress. Split out
 * so a caller that owns its own scroll container (and wants to drive text
 * from the same progress, or mount the canvas lazily) can reuse it.
 */
...
export interface ScrollDissolveRevealProps {
  ...
  /** Overlay content, rendered inside the sticky frame above the canvas. */
