  ...
  return (
    ...
    >
      ...
      <a
        ...
        className={cn(
          // h-12 against the 64px row: two text lines plus the icon disc
          // need real headroom, not just enough room to technically fit.
          // The previous h-10 sized the card to the content's minimum, so
          // the background and the text read as the same size — cramped
      ...
      >
        {stats.map((stat, i) => (
          <span
            ...
            className={cn(
              "absolute inset-0 items-center gap-2.5 px-3",
              i === index
