...
type Skill = NonNullable<Post["skill"]>;

export function useLiveSkill(postId: string, skill: Skill) {
...
export function LiveRatingPair({ postId, skill }: { postId: string; skill: Skill }) {
